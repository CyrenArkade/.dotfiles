...
local resolutions = {
  thin = make_res(340, monitor_h, thin_enable, res_disable),
  tall = make_res(340, 16384, tall_enable, res_disable),
  wide = make_res(monitor_w, 340, wide_enable, res_disable),
}
